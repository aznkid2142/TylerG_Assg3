...
public class MainActivity extends AppCompatActivity {
    ...
    public final static int SWATCH_REQUEST_CODE = 2;
    ...
    public void onAlarmClick(View view) {
        ...
        startActivityForResult(intentAlarm, ALARM_REQUEST_CODE);
    }

    public void onSwatchClick(View view) {
        Intent intentSwatch = new Intent(this, StopwatchActivity.class);
        startActivityForResult(intentSwatch, SWATCH_REQUEST_CODE);
